...
| ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ---------------------------------------------------------------------------------------- |
| Default deny: an empty ACL grants nothing, and an unresolvable ACL is a separate, louder failure                               | `packages/contracts/src/acl.ts`          | `contracts.test.ts` — "treats an empty readable set as nobody, never as everybody"       |
