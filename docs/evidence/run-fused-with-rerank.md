# Evaluation run sha256:da51db3646af5a01ac1f181829232dd85c2657e542eaba70b50d411ee7bd9a9a

- **System:** atlasops
- **Arm:** fused-with-rerank
- **Commit:** d1b5c50
- **Measured at:** 2026-09-25T15:00:25.644Z
...
| --- | --- | --- | --- |
| recall@10 | 0.7576 | 11 | mean |
| nDCG@10 | 0.7145 | 11 | mean |
| MRR | 0.7152 | 11 | mean |
| contribution:dense | 1 | 11 | mean |
| contribution:lexical | 0.7424 | 11 | mean |

### Fusion and rerank

_Not measured: this run is the "fused-with-rerank" arm; the deltas are a comparison across arms._

### Citation

| Metric | Value | Queries | Aggregation |
| --- | --- | --- | --- |
| citation-precision | 0.8333 | 6 | mean |
| citation-recall | 0.8333 | 6 | mean |
...
| Metric | Value | Queries | Aggregation |
| --- | --- | --- | --- |
| supported-claim-rate | 0.8333 | 6 | mean |
| contradiction-rate | 0.1667 | 6 | mean |
