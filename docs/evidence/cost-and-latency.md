...
- **Commit:** cd06e78
- **Run:** 2026-09-25T15:39:40.440Z → 2026-09-25T15:41:26.420Z
...
| ------ | ------ | -------- | ------- | ------ |
| ANSWER-LATENCY-P95 | 3000 ms | 4755.8209 ms (**over**) | 260 | scripted load run, fixed workload, stated concurrency |
| TIME-TO-FIRST-TOKEN-P95 | 1200 ms | 726.6957 ms (within) | 260 | streaming instrumentation on the same run |
| RETRIEVAL-STAGE-P95 | 400 ms | 564.0732 ms (**over**) | 13 | span aggregation |
| RERANK-STAGE-P95 | 500 ms | **not measured** | — | span aggregation at fixed candidate depth |
| PERMISSION-P95 | 50 ms | 0.0306 ms (within) | 260 | span aggregation |
| VERIFICATION-P95 | 100 ms | 0.0549 ms (within) | 260 | span aggregation |
...
- **TIME-TO-FIRST-TOKEN-P95** — time until the model's first token, from the start of the request. No answer reaches the caller then: it is returned whole, after verification (PRD 7.2)
...
| ----- | -------- | -------- | ------- |
| end-to-end | 1341.43 | 4755.82 | 260 |
| end-to-end (retrieval cache miss) | 1717.55 | 8211.4 † | 13 |
| end-to-end (retrieval cache hit) | 1337.29 | 4755.82 | 247 |
| audit-write | 0.04 | 0.09 | 260 |
| dense-retrieval | 246.13 | 563.89 † | 13 |
| fusion | 0.02 | 8.33 † | 13 |
| generation | 1334.94 | 4755.48 | 260 |
| lexical-retrieval | 0.26 | 0.49 † | 13 |
| permission-compile | 0.01 | 0.01 | 260 |
| permission-resolution | 0 | 0.01 | 260 |
| prompt-assembly | 0.02 | 0.05 | 260 |
| query-normalisation | 0.04 | 0.09 | 260 |
| verification | 0.02 | 0.05 | 260 |
